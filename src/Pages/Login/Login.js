...
const Login = () => {
    ...
    const { loginByEmail, signUpByGoogle, signUpByGitHub } = useContext(AuthUserContext);
            ...
            <div className="hero-content flex-col lg:flex-row-reverse">
                ...
                <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                    ...
                    <div className='card-body'>
                        ...
                        <button onClick={signUpByGitHubHandler} className='btn btn-outline' ><FaGithub className='mr-2' /> Login with gitHub</button>
                    </div>
                </div>
            </div>
        </div>
